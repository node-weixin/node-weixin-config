...
describe('node-weixin-config tests', function () {
  it('should not be able to init app', function () {
    ...
    assert.throws(function () {
      ...
      if (/Invalid app data: {"key":"token","reason":"Key token is undefined"}/.test(err)) {
        return true;
      }
      return false;
    });
  ...
  it('should not be able to init merchant', function () {
    ...
    assert.throws(function () {
      ...
      if (/Invalid Merchant Data: {"key":"key","reason":"Key key is undefined"}/.test(err)) {
        return true;
      }
      return false;
    });
  ...
  it('should not be able to init oauth', function () {
    ...
    assert.throws(function () {
      ...
      if (/Invalid oauth data: {"key":"redirect","reason":"Key redirect is undefined"}/.test(err)) {
        return true;
      }
      return false;
    });
  ...
  it('should not be able to init jssdk', function () {
    ...
    assert.throws(function () {
      ...
      if (/Invalid jssdk data: {"key":"pay","reason":"Key pay is undefined"}/.test(err)) {
        return true;
      }
      return false;
    });
